...
<div class="sigil-frame bevel-out" style="--sigil-size: {size}px;" aria-hidden="true">
	<div class="sigil-inner">
		...
		{:else}
			...
			>
				<rect x="0" y="0" width="100" height="100" fill="var(--stone-1)" />

				{#each spec.cells as filled, i (i)}
					{#if filled}
						...
						{#if spec.shape === 0}
							<!-- triangle -->
							<polygon
								points="{c * 18 + 8},{r * 18 + 22} {c * 18 + 18},{r * 18 + 22} {c * 18 + 13},{r *
									18 +
									11}"
						...
						{:else if spec.shape === 1}
							<!-- hexagon -->
							<polygon
								points="{c * 18 + 8},{r * 18 + 16} {c * 18 + 11},{r * 18 + 11} {c * 18 + 15},{r *
									18 +
									11} {c * 18 + 18},{r * 18 + 16} {c * 18 + 15},{r * 18 + 21} {c * 18 + 11},{r *
									18 +
									21}"
								fill={spec.useGold ? 'var(--gold-base)' : 'var(--bone-muted)'}
							/>
						{:else if spec.shape === 2}
							<!-- lozenge -->
							<polygon
								points="{c * 18 + 13},{r * 18 + 10} {c * 18 + 19},{r * 18 + 16} {c * 18 + 13},{r *
									18 +
									22} {c * 18 + 7},{r * 18 + 16}"
								fill={spec.useGold ? 'var(--gold-base)' : 'var(--bone-muted)'}
							/>
						...
						{:else if spec.shape === 4}
							<!-- 4-point star -->
							<polygon
								points="{c * 18 + 13},{r * 18 + 9} {c * 18 + 15},{r * 18 + 15} {c * 18 + 20},{r *
									18 +
									16} {c * 18 + 15},{r * 18 + 17} {c * 18 + 13},{r * 18 + 23} {c * 18 + 11},{r *
									18 +
									17} {c * 18 + 6},{r * 18 + 16} {c * 18 + 11},{r * 18 + 15}"
								fill={spec.useGold ? 'var(--gold-base)' : 'var(--bone-muted)'}
							/>
						{:else}
							...
							<g fill={spec.useGold ? 'var(--gold-base)' : 'var(--bone-muted)'}>
								...
								<rect x={c * 18 + 10} y={r * 18 + 11} width="9" height="9" fill="var(--stone-1)" />
							</g>
						{/if}
					{/if}
				{/each}
				...
				{#if (spec.accent & 1) === 1}
					<line x1="0" y1="0" x2="100" y2="100" stroke="var(--gold-faint)" stroke-width="0.5" />
				{/if}
				{#if (spec.accent & 2) === 2}
					<line x1="100" y1="0" x2="0" y2="100" stroke="var(--gold-faint)" stroke-width="0.5" />
				{/if}
				{#if (spec.accent & 4) === 4}
