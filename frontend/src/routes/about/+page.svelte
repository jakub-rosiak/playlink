...
<div class="about-page">
	...
	<div class="column">
		<InnerPanel>
			<p class="lead">
				Playlink is a place to find people to play <em>old games</em> with — the kind of games that
				no longer have matchmaking, no longer have a healthy lobby browser, no longer have anyone
				waiting on the other side of the queue.
				<em>Quake III. Diablo II. StarCraft. Half-Life. Unreal Tournament.</em> The shelf is small and
				personal on purpose.
			</p>

			<p class="prose">
				You post a lobby. The lobby is a tiny, time-boxed agreement: this game, this many players,
				this long. Everyone connected to the hall sees it appear on the Game List the moment you
				broadcast it. Anyone with the right key can walk in. When the run is over, the lobby quietly
				expires and gets out of the way — there is no graveyard of dead servers here.
			</p>
			...
			<p class="prose">
				There are no email accounts here. Your identity is a twelve-word recovery phrase you
				generate once and keep. The phrase never leaves your machine; the server only ever sees a
				signature proving you hold it. Lose the phrase and you lose the seat — that is the trade.
			</p>

			<p class="prose closing">
				This is a small project. It exists because finding three other people who still want to play
				vanilla Quake on a Tuesday evening shouldn't require a Discord raid.
			</p>
		</InnerPanel>
	</div>
</div>
